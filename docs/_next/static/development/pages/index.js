...
var Resume = function Resume() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Page__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    points: ["Enabling team success through architectural decisions, scope definition, pair programming, code reviews, and general leadership and guidance.", "Architecting scalable internal cross-application services using Ruby on Rails.", "Building consumer-grade application front-ends with React, Redux, and WebPack."],
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22
    },
