...
function extractTags(posts: ProcessedPost[]): string[] {
...
function generateBlogMetadata(): void {
  ...
  const tsOutputPath = path.join(projectRoot, "src/blog-metadata.gen.ts");
...
`;
  ...
  console.log(`📦 Generated blog content metadata: ${tsOutputPath}`);
}
