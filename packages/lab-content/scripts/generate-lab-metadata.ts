...
function generateLabMetadata(): void {
  ...
  // Generate TypeScript metadata file (types + data in one file)
  const tsOutputPath = path.join(projectRoot, "src/lab-metadata.gen.ts");
...
`;
  ...
  console.log(`📦 Generated lab content metadata: ${tsOutputPath}`);
}
